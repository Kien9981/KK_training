Shader "Horus/Terrain/4 Modifiable Details"
{
    Properties
    {
        ...
        _MaskMultiply ("Mask Multiply", vector) = (1, 1, 1, 1)
    ...
    SubShader
    {
        ...
        float4 _Tiling, _Tiling1, _Tiling2, _Tiling3, _Tiling4, _Tiling5, _Tiling6, _MaskMultiply;
    ...
    CustomEditor "_Game.THIN.Scripts.Editor.ShaderCustomEditors.Terrain4ModifiableDetailsShaderGUI"
}